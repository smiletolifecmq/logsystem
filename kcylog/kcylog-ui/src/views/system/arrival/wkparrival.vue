  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:wkparrival:add']"
          >新增</el-button
        >
      </el-col>
      <right-toolbar
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-if="showButton(scope.row.dzFzr)"
            v-hasPermi="['system:wkparrival:edit']"
            >修改</el-button
          >
          <el-button
            size="mini"
            ...
            v-if="showButton(scope.row.dzFzr)"
            v-hasPermi="['system:wkparrival:delete']"
            >删除</el-button
          >
        </template>
      </el-table-column>
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="负责人" prop="dzFzr" label-width="150px">
          <el-input v-model="form.dzFzr" placeholder="请输入负责人" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      // 表单校验
      rules: {
        dzFzr: [{ required: true, message: "请输入负责人", trigger: "blur" }],
      },
    };
  },
  created() {
