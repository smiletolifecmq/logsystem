...
export default {
  ...
  methods: {
    handleChangeBusinessNameS(value) {
      this.formReviewSub.cooperationUnitJson = [];
      this.winUnits = [];
      for (let i = 0; i < this.businessNameMap.get(value).length; i++) {
        ...
        this.formReviewSub.cooperationUnitJson.push(
          this.businessNameMap.get(value)[i]
        );
      }
    },
    showFetailXt(value) {
    ...
    submitFormReviewSub(status) {
      ...
      if (
        this.formReviewSub.winUnit != "" &&
        this.formReviewSub.businessName != "" &&
        this.formReviewSub.winUnit != undefined &&
        this.formReviewSub.businessName != undefined &&
        this.formReviewSub.winUnit != null &&
        this.formReviewSub.businessName != null
      ) {
        let lastFiveChars = this.formReviewSub.businessName.slice(-5);
        this.formReviewSub.subcontractNo = this.subcontractNoMap.get(
