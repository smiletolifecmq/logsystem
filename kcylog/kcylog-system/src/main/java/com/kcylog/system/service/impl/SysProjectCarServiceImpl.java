...
public class SysProjectCarServiceImpl implements ISysProjectCarService 
{
    ...
    {
        return sysProjectCarMapper.insertProjectCarBatch(projectCars);
    }

    @Override
    public int deleteProjectCarByCarReviewIds(Long[] carReviewIds)
    {
        return sysProjectCarMapper.deleteProjectCarByCarReviewIds(carReviewIds);
    }

    @Override
    public int deleteProjectCarByCarReviewId(Long carReviewId)
    {
        return sysProjectCarMapper.deleteProjectCarByCarReviewId(carReviewId);
    }
}
